...
async function sendAdminEmail(client, data, smtpUsername, language) {
  ...
  await client.send({
    ...
    replyTo: data.email // Add reply-to header for easier admin workflow
  });
}
