...
-- Update linkedin_accounts RLS policies to require admin role or own accounts
...
-- Update linkedin_campaigns RLS policies to require admin role or own campaigns
...
-- Update linkedin_actions RLS policies to check campaign ownership
