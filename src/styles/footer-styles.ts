...
export const footerStyles = {
  // Container styles
  container: "bg-brand-footer text-white pt-20 pb-8",
  ...
  bodyText: "text-white text-sm font-sans",
  linkText: "text-white hover:text-brand-background transition-colors",
  ...
  divider: "mt-12 pt-8 border-t border-gray-800",
  ...
  copyright: "text-sm text-white font-sans",
  
  // Rating section
  ratingContainer: "flex items-center",
  starIcon: "h-3.5 w-3.5 fill-[#facc15] text-[#facc15]",
  ratingLink: "text-gray-400 hover:text-gray-300 transition-colors text-sm ml-2",
