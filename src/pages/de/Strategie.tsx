...
// Updated SEO Text Section Component
    ...
    <section className="bg-[#0A1E2C] pt-12 pb-16 font-satoshi">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <article className="prose prose-lg max-w-none text-[17px] leading-relaxed" style={{ color: '#FFFFFF' }}>
          <h2 className="text-3xl md:text-4xl font-bold mb-8" style={{ color: '#FFFFFF' }}>Webkonzept & Strategie – Klar. Strukturiert. Erfolgreich.</h2>
          ...
          <h3 className="text-2xl md:text-3xl font-bold mt-12 mb-6" style={{ color: '#FFFFFF' }}>Warum Ihre Website ein Webkonzept braucht</h3>
          ...
          <h3 className="text-2xl md:text-3xl font-bold mt-12 mb-6" style={{ color: '#FFFFFF' }}>Individuelle Webkonzepte – keine Lösungen von der Stange</h3>
          ...
          <h3 className="text-2xl md:text-3xl font-bold mt-12 mb-6" style={{ color: '#FFFFFF' }}>Unser Ansatz – strategisch, partnerschaftlich, transparent</h3>
          
          <p className="my-6" style={{ color: '#F4F4F4' }}>
            <strong className="font-bold">Analyse & Webkonzept:</strong> Wir starten mit einer tiefgehenden Analyse Ihrer aktuellen Website, Ihrer Zielgruppen und Ihres Wettbewerbs. Daraus entwickeln wir Ihr individuelles Webkonzept – inklusive Sitemap, Content-Strategie, Wireframes und Conversion-Logik.
          </p>
          
          <p className="my-6" style={{ color: '#F4F4F4' }}>
            <strong className="font-bold">Strategie & Planung:</strong> Gemeinsam definieren wir Ihre Ziele und KPIs, planen alle Maßnahmen und erstellen eine Roadmap, damit Sie jederzeit wissen, wo Ihr Projekt steht.
          </p>
          
          <p className="my-6" style={{ color: '#F4F4F4' }}>
            <strong className="font-bold">Design-Übergabe:</strong> Ihr Webkonzept bildet die Grundlage für das Screendesign. Hier gestalten wir die visuelle Identität Ihrer Marke – mobiloptimiert, benutzerfreundlich und ästhetisch überzeugend.
          </p>
          
          <p className="my-6" style={{ color: '#F4F4F4' }}>
            <strong className="font-bold">Technische Umsetzung:</strong> Nach dem Design startet die Webentwicklung: performant, sicher und skalierbar – für eine Website, die heute und morgen funktioniert.
          </p>
          
          <p className="my-6" style={{ color: '#F4F4F4' }}>
            <strong className="font-bold">Optimierung & Betreuung:</strong> Wir sind auch nach dem Go-Live für Sie da. Mit kontinuierlichem Monitoring, regelmäßigen Analysen und datenbasierten Empfehlungen, damit Ihr Webkonzept langfristig erfolgreich bleibt.
          </p>
          
          <h3 className="text-2xl md:text-3xl font-bold mt-12 mb-6" style={{ color: '#FFFFFF' }}>Erfolgsgeschichten – unsere Projekte als strategischer Erfolgsfaktor</h3>
          ...
          <p className="my-6" style={{ color: '#F4F4F4' }}>
            <strong className="font-bold">Ausgangslage:</strong> Fehlende Sichtbarkeit und geringe Online-Bestellungen.<br />
            <strong className="font-bold">Unser Ansatz:</strong> Zielgruppenanalyse, individuelles Webkonzept mit SEO-Integration und Conversion-Optimierung.<br />
            <strong className="font-bold">Ergebnis:</strong> +150 % Online-Bestellungen, Top-Rankings bei Google, Website-Link auf Anfrage.
          </p>
          ...
          <p className="my-6" style={{ color: '#F4F4F4' }}>
            <strong className="font-bold">Ausgangslage:</strong> Unscharfe Markenbotschaft, wenig Struktur.<br />
            <strong className="font-bold">Unser Ansatz:</strong> Zielgruppenanalyse, klare Markenpositionierung, maßgeschneidertes Webkonzept.<br />
            <strong className="font-bold">Ergebnis:</strong> 3x mehr Leads, nachhaltige Markenwahrnehmung.
          </p>
          ...
          <p className="my-6" style={{ color: '#F4F4F4' }}>
            <strong className="font-bold">Ausgangslage:</strong> Geringe Conversion, veraltetes CMS.<br />
            <strong className="font-bold">Unser Ansatz:</strong> Analyse, neue Sitemap, Conversion-Optimierung, individuelles Webkonzept.<br />
            <strong className="font-bold">Ergebnis:</strong> +200 % Online-Anfragen, gesteigerte Kundenbindung.
          </p>
          ...
          <h3 className="text-2xl md:text-3xl font-bold mt-12 mb-6" style={{ color: '#FFFFFF' }}>Langfristige Zusammenarbeit – Vertrauen, das bleibt</h3>
          ...
          <h3 className="text-2xl md:text-3xl font-bold mt-12 mb-6" style={{ color: '#FFFFFF' }}>Kundenfeedback aus Expertensicht – unsere Arbeitsweise im Spiegel</h3>
          ...
          <h3 className="text-2xl md:text-3xl font-bold mt-12 mb-6" style={{ color: '#FFFFFF' }}>Warum ooliv?</h3>
          ...
          <h3 className="text-2xl md:text-3xl font-bold mt-12 mb-6" style={{ color: '#FFFFFF' }}>Jetzt starten – Webkonzept & Strategie aus einer Hand</h3>
