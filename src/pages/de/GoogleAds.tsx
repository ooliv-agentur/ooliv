...
const GermanGoogleAds = () => {
  ...
  return (
    ...
    >
        ...
        <div className="relative z-20 w-full">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="max-w-4xl mx-auto flex flex-col justify-center items-start min-h-[60vh]">
              {/* Badge */}
              <div className="mb-6">
                <span className="inline-block bg-medico-turquoise/20 text-medico-turquoise px-4 py-2 rounded-full text-sm font-medium">
                  Traffic zu Leads zu Ergebnissen
                </span>
              </div>
      ...
      {/* Services Section - Following startpage color scheme */}
      <section className="py-16 md:py-24" style={{ backgroundColor: '#0A1E2C' }}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
