    ...
    <section className={`${seoTextStyles.container} ${seoTextStyles.containerBackground}`}>
      <div className={seoTextStyles.innerContainer}>
        <article className={seoTextStyles.articleWrapper} style={{ color: '#FFFFFF' }}>
          <h2 className={seoTextStyles.mainHeading} style={{ color: '#FFFFFF' }}>Content Agentur Mainz – Strategische Inhalte für Ihren Geschäftserfolg</h2>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Unsere Leistungen als Content Marketing Agentur Mainz</h3>
          <p className={seoTextStyles.paragraph} style={{ color: '#F4F4F4' }}>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Content-Erstellung mit System – von der Analyse bis zur Skalierung</h3>
          <p className={seoTextStyles.paragraph} style={{ color: '#F4F4F4' }}>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Content, der gefunden wird – und konvertiert</h3>
          <ul className={seoTextStyles.unorderedList} style={{ color: '#F4F4F4' }}>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Content-Formate, die Ihre Ziele unterstützen</h3>
          <ul className={seoTextStyles.unorderedList} style={{ color: '#F4F4F4' }}>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Warum ooliv? Ihre Content Agentur Mainz mit klarer Philosophie</h3>
          <ul className={seoTextStyles.unorderedList} style={{ color: '#F4F4F4' }}>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Workshops & Trendberatung</h3>
          <p className={seoTextStyles.paragraph} style={{ color: '#F4F4F4' }}>Wir bieten praxisnahe Workshops für Ihr Team zu Themen wie:</p>
          <ul className={seoTextStyles.unorderedList} style={{ color: '#F4F4F4' }}>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Die Rolle der KI – Effizienz trifft Qualität</h3>
          <ul className={seoTextStyles.unorderedList} style={{ color: '#F4F4F4' }}>
          ...
          <p className={seoTextStyles.paragraph} style={{ color: '#F4F4F4' }}>KI unterstützt – der Mensch entscheidet. Für authentische, wirkungsvolle Inhalte.</p>

          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Häufig gestellte Fragen zur Content-Erstellung</h3>
          <div className="space-y-4 mt-4 mb-6">
            <div>
              <p style={{ color: '#F4F4F4' }}><strong style={{ color: '#FFFFFF' }}>Wie lange dauert die Erstellung?</strong> – 2-5 Werktage für Einzelprojekte, 2-4 Wochen für Kampagnen.</p>
            </div>
            <div>
              <p style={{ color: '#F4F4F4' }}><strong style={{ color: '#FFFFFF' }}>Optimiert ihr bestehenden Content?</strong> – Ja, durch Audits, Re-Optimierung und SEO-Updates.</p>
            </div>
            <div>
              <p style={{ color: '#F4F4F4' }}><strong style={{ color: '#FFFFFF' }}>Bietet ihr Workshops an?</strong> – Ja, zu Content-Strategie, Social Media Infrastruktur und Canva-Design.</p>
            </div>
            <div>
              <p style={{ color: '#F4F4F4' }}><strong style={{ color: '#FFFFFF' }}>Wie integriert ihr SEO?</strong> – Über Keyword-Recherche, Strukturierung und technische SEO.</p>
            </div>
            <div>
              <p style={{ color: '#F4F4F4' }}><strong style={{ color: '#FFFFFF' }}>Ist Content-Erstellung mit KI möglich?</strong> – Ja, kombiniert mit menschlicher Expertise.</p>
            </div>
          </div>

          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Branchenspezifischer Content für maximale Relevanz</h3>
          <p className={seoTextStyles.paragraph} style={{ color: '#F4F4F4' }}>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Erfolgsgeschichten aus der Praxis</h3>
          <ul className={seoTextStyles.unorderedList} style={{ color: '#F4F4F4' }}>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Social Media Content, der Ihre Community begeistert</h3>
          <ul className={seoTextStyles.unorderedList} style={{ color: '#F4F4F4' }}>
          ...
          <h3 className={seoTextStyles.sectionHeading} style={{ color: '#FFFFFF' }}>Jetzt Ihr Content Projekt starten</h3>
          <ul className={seoTextStyles.unorderedList} style={{ color: '#F4F4F4' }}>
