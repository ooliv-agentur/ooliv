...
const AboutUsHero = () => {
  ...
  return (
    <Section className="relative bg-[#F5F7F7] overflow-hidden min-h-screen flex items-center" spacing="large">
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-20">
        <div className="flex flex-col items-center space-y-2">
          <div className="w-1 h-6 sm:h-8 bg-gradient-to-b from-[#32b2ab]/50 to-[#32b2ab]/80 rounded-full animate-pulse"></div>
          <div className="flex space-x-1">
          <div className="w-1 sm:w-1.5 h-1 sm:h-1.5 bg-[#32b2ab]/80 rounded-full animate-pulse"></div>
            <div className="w-1 sm:w-1.5 h-1 sm:h-1.5 bg-[#32b2ab]/80 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
            <div className="w-1 sm:w-1.5 h-1 sm:h-1.5 bg-[#32b2ab]/80 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
          </div>
        </div>
      </div>
    </Section>
