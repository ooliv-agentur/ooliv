      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 relative z-20">
        <div className="text-center space-y-8 animate-fade-up">
          <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight">
            Webdesign Agency for Business Growth – Let's Build It Right
          </h1>
          
          <p className="max-w-2xl mx-auto text-xl text-gray-100">
            Your website is more than just design—it's a strategic tool for success. As a leading Webdesign Agency, we create high-performance websites that attract customers, build trust, and generate measurable results—whether you need a complete relaunch or a brand-new online presence.
          </p>
