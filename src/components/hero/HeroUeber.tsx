...
const HeroUeber = () => {
  ...
  const translations = {
    en: {
      ...
      subtitle: "Since 2008, we've been designing and developing high-performance websites for B2B companies that want to grow online."
    },
    de: {
      badge: "Über ooliv",
      title: "Wir entwickeln Websites, die Unternehmen wachsen lassen",
      subtitle: "Seit 2008 entwerfen und entwickeln wir leistungsstarke Websites für B2B-Unternehmen, die online wachsen wollen."
    }
  };
