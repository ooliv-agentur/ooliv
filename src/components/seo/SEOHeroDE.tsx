        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-brand-heading/80 mb-8">
              Wir verwandeln Ihre Website in einen Wachstumstreiber. Strategiegetriebene SEO-Optimierung für bessere Rankings, qualifizierte Anfragen und nachhaltiges Business-Wachstum – in Mainz und darüber hinaus.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <HeroButton 
                variant="solid"
                label="SEO-Strategie starten"
                onClick={handleOpenLeadForm}
              />
              
              <HeroButton 
                variant="outline"
                label="Kostenloses SEO-Audit anfordern"
                href="/kontakt"
              />
            </div>
          </div>
