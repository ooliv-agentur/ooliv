      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-brand-heading mb-6 leading-tight">
            SEO Optimization That Drives B2B Growth
          </h1>
          
          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-brand-heading/80 mb-8">
            We turn your website into a traffic magnet. Strategic SEO services that boost visibility, attract qualified leads, and drive measurable results.
          </p>
