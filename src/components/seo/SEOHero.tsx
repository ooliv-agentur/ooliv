...
const SEOHero: React.FC<SEOHeroProps> = ({ pageTag }) => {
  return (
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <div className="inline-block bg-brand-primary/10 rounded-full px-4 py-1.5 text-brand-primary font-medium text-sm mb-6">
            {pageTag || "SEO Optimization"}
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-brand-heading">
            SEO That Drives Business Goals
          </h1>
          <p className="text-xl max-w-3xl mx-auto text-brand-text">
            We build visibility that matters. Our SEO approach combines technical excellence, content strategy, and measurable results for B2B companies.
          </p>
