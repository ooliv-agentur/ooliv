        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-brand-heading mb-6 leading-tight">
              SEO Services in Mainz That Deliver Visibility & Qualified Leads
            </h1>
            
            <p className="text-xl md:text-2xl text-brand-heading/80 mb-8">
              We turn your website into a scalable growth engine. Strategy-first SEO to boost visibility, attract B2B leads, and achieve long-term business results — in Mainz and beyond.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <HeroButton 
                variant="solid"
                label="Start Your SEO Strategy"
                onClick={handleOpenLeadForm}
              />
              
              <HeroButton 
                variant="outline"
                label="Request Free SEO Audit"
                href="/en/contact"
              />
            </div>
          </div>
