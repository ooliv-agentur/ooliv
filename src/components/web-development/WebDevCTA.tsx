    ...
    <section className="py-24 bg-gradient-to-br from-brand-background to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
          <Button 
            className="flex-1 hover:scale-[1.03] transition-transform duration-200 ease-in-out"
            asChild
          >
            <Link to={contactPath}>
              {consultationText}
          ...
          <Button 
            variant="outline" 
            className="flex-1 border-[#006064] text-[#006064] hover:bg-[#006064]/10 hover:scale-[1.03] transition-transform duration-200 ease-in-out"
