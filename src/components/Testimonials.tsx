...
const Testimonials = ({ title, subtitle, testimonials: customTestimonials }: TestimonialsProps = {}) => {
  const { t } = useLanguage();
  ...
  // Use testimonials if provided as props, or convert default testimonials to the simplified format
  const displayTestimonials = customTestimonials || defaultTestimonials.map(t => ({
    quote: t.quote,
    author: t.author.name,
    role: t.author.position
  }));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold text-brand-heading mb-6 font-sans">
            ...
            <span className="text-brand-primary"> {subtitle || t('testimonials.subtitle')}</span>
          </h2>
