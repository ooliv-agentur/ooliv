...
const EmailCaptureController: React.FC = () => {
  ...
  // Automatic triggers disabled - only manual triggers via URL param for testing
  // Dwell time trigger - DISABLED
  // useEffect(() => {
  //   if (!canShow) return;
  ...
  // Exit-intent trigger (desktop) - DISABLED
  // useEffect(() => {
  //   if (!canShow) return;
  ...
  // Scroll-depth trigger (mobile fallback) - DISABLED
  // useEffect(() => {
  //   if (!canShow) return;
  //   const onScroll = () => {
