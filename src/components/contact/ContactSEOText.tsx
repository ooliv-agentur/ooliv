    ...
    <section className="bg-[#f7fafa] pt-12 pb-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <article className="prose prose-lg max-w-none text-[17px] leading-relaxed text-gray-700">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">Kontakt ooliv – Ihre Digitalagentur aus Mainz</h2>
          ...
          <h3 className="text-xl md:text-2xl font-bold text-gray-800 mt-8 mb-4">Unsere Kunden schätzen insbesondere:</h3>
          ...
          <h3 className="text-xl md:text-2xl font-bold text-gray-800 mt-8 mb-4">Über ooliv:</h3>
          <p>
          ...
          <p>
            👉 Jetzt Projekt starten oder direkt Kontakt aufnehmen.
          </p>
        </article>
      </div>
    </section>
