    ...
    <section className="bg-white border-t border-gray-200 py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <div className="prose prose-lg max-w-none">
          <h3>Webdesign Mainz – individuelles Design, strategischer Aufbau, rechtliche Sicherheit</h3>
          ...
          <h3>Individuelle Website statt Baukasten – warum Standardlösungen nicht ausreichen</h3>
          ...
          <p>Dabei achten wir auf eine durchgängige Designlogik, strukturierte Inhaltsmodelle und vollständige SEO-Integration.</p>
          
          <h3>Der Webdesign-Prozess: von der Analyse bis zum Launch</h3>
          ...
          <p>Jede Phase ist dokumentiert, abgestimmt und strukturiert – mit direkter Kommunikation über Basecamp und klaren Timelines.</p>
          
          <h3>Webtechnik, CMS & Benutzerfreundlichkeit</h3>
          ...
          <p>So bleibt Ihre Seite auch nach dem Launch lebendig – ohne laufende Abhängigkeit von Entwicklerteams.</p>
          
          <h3>Datenschutz, DSGVO und technische Sicherheit</h3>
          ...
          <p>So schützen Sie Ihre Besucher und Ihre Marke – ganz ohne Kompromisse beim Design.</p>
          
          <h3>SEO & Online-Marketing: Sichtbarkeit als Strategie</h3>
          ...
          <p>
            ...
            ergänzt durch Maßnahmen im Online-Marketing.
          </p>
          
          <p>Unsere SEO-Strategie:</p>
          ...
          <p>Ob SEO-ready Webseiten, Conversion-Funnel oder datenbasiertes Kampagnen-Setup – wir bauen Websites, die sichtbar sind und bleiben.</p>
          
          <h3>Referenzen & Kundenstimmen – Projekte, die Ergebnisse liefern</h3>
          ...
          <p>Auswahl realisierter Kundenprojekte:</p>
          
          <p>
            <strong>Klaiber Steuerberatung</strong><br />
            <em>"Unsere neue Website repräsentiert endlich, was uns als Beratung ausmacht: Klarheit, Vertrauen und Dynamik. 
            Die Zusammenarbeit mit ooliv war strukturiert und zielführend."</em><br />
            Website live erleben: <a href="https://www.kl-klaiber.de" target="_blank" rel="noopener noreferrer">www.kl-klaiber.de</a>
          </p>
          
          <p>
            <strong>COBUS Industries</strong><br />
            <em>"Unsere neue Website verbindet Technik, Service und Markenanspruch. Die Zusammenarbeit war strukturiert, kreativ und zielorientiert."</em><br />
            Website live erleben: <a href="https://www.cobus-industries.de" target="_blank" rel="noopener noreferrer">www.cobus-industries.de</a>
          </p>
          
          <p>
            <strong>SPEZ AG</strong><br />
            <em>"Mit ooliv konnten wir SPEZ sichtbar machen. Die neue Marke überzeugt technisch und emotional – und generiert seit dem Launch konstant qualifizierte Anfragen."</em><br />
            Website live erleben: <a href="https://www.spez-ag.ch" target="_blank" rel="noopener noreferrer">www.spez-ag.ch</a>
          </p>
          
          <p>
            <strong>IconPro GmbH</strong><br />
            <em>"Dank ooliv wirkt unsere Website jetzt genauso wie unsere Software: durchdacht, strukturiert und visuell überzeugend."</em><br />
            Website live erleben: <a href="https://www.iconpro.com" target="_blank" rel="noopener noreferrer">www.iconpro.com</a>
          </p>
          
          <p>
            <strong>Quartier am Kliff</strong><br />
            <em>"Mit ooliv haben wir ein Projekt geschaffen, das unsere Architektur, Lage und Vision überzeugend digital inszeniert. Die Seite unterstützt uns aktiv im Vertrieb."</em><br />
            Website live erleben: <a href="https://www.amkliff.de" target="_blank" rel="noopener noreferrer">www.amkliff.de</a>
          </p>
          
          <p>Unsere Expertise:</p>
          ...
          <h3>Fazit: Webdesign Mainz mit Tiefe, Struktur und Wirkung</h3>
          ...
          <p>Mit ooliv profitieren Sie von:</p>
          ...
          <p>Starten wir gemeinsam Ihr Webprojekt – mit Strategie, Struktur und Substanz.</p>
        </div>
      </div>
    </section>
  );
