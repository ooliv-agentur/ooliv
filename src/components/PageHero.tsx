...
const PageHero = ({
  ...
  const renderTitle = () => {
    if (isHomepage) {
      return (
        <div className="mb-8">
          <h1 
            className="font-bold leading-tight text-left text-4xl sm:text-5xl md:text-6xl lg:text-[64px] lg:leading-[76px] mb-8 text-foreground"
          >
      ...
      return (
        <h1 
          className="font-bold leading-tight text-left mb-8 text-4xl sm:text-5xl md:text-6xl lg:text-[64px] lg:leading-[76px] text-foreground"
        >
          {title}
        </h1>
      );
  ...
  return (
    <section className="relative bg-background overflow-hidden min-h-screen flex items-center py-24">
      <div className="relative z-20 w-full">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1240px]">
          <div className="max-w-4xl flex flex-col justify-center items-start min-h-[60vh]">
            {badge && (
              <p className="text-sm font-medium mb-6 uppercase tracking-wide text-primary">
                {badge}
              </p>
            )}
            {renderTitle()}
